...
import { Bot, User, Clock, Search, Trash2, Ghost } from 'lucide-react';
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center flex-1 text-zinc-500 gap-4">
            ...
            <div className="text-center">
              <p className="text-lg font-medium text-zinc-300 mb-1">لا يوجد سجل حالياً</p>
              <p className="text-sm text-zinc-500 max-w-[250px]">
                لم تقم بأي نشاط حتى الآن. ابدأ العمل وسيظهر السجل هنا.
              </p>
            </div>
          </div>
        ) : (
